      ...
      <div className="flex flex-col space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            {Object.entries(PropertyTypeIcons).map(([type, Icon]) => (
              <div
                key={type}
                className={cn(
                  "flex flex-col items-center justify-center p-4 border rounded-xl cursor-pointer hover:bg-primary-100",
        ...
        <div className="flex gap-4">
          <div className="flex-1">
            ...
            >
              <SelectTrigger className="w-full rounded-xl">
                <SelectValue placeholder="Beds" className="select-option">
              ...
              <SelectContent>
                <SelectItem value="any" className="select-option">
                  Any beds
                </SelectItem>
                <SelectItem value="1" className="select-option">
                  1+ bed
                </SelectItem>
                <SelectItem value="2" className="select-option">
                  2+ beds
                </SelectItem>
                <SelectItem value="3" className="select-option">
                  3+ beds
                </SelectItem>
                <SelectItem value="4" className="select-option">
                  4+ beds
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="flex-1">
            ...
            >
              <SelectTrigger className="w-full rounded-xl">
                <SelectValue placeholder="Baths" className="select-option">
          ...
          <div className="flex flex-wrap gap-2">
            {Object.entries(AmenityIcons).map(([amenity, Icon]) => (
              <div
                key={amenity}
                className={cn(
                  "flex items-center space-x-2 p-2 border rounded-lg hover:cursor-pointer hover:bg-primary-100",
        ...
        <div className="flex gap-4 mt-6">
          ...
          <Button
            onClick={handleReset}
            variant="outline"
            className="flex-1 rounded-xl bg-white border-primary-400 hover:bg-primary-100"
          >
            Reset Filters
          </Button>
        </div>
